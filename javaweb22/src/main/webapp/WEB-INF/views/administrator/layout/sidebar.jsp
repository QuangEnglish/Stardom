	...
	<ul class="nav">
		<li class="nav-item nav-profile"><a href="#" class="nav-link">
				<div class="nav-profile-image">
					<img src="${base}/img/images/anhdaidien.jpg" alt="profile"> <span
		...
		<li class="nav-item"><a class="nav-link" href="index.html"> <span
				class="menu-title">Trang Chủ</span> <i
		...
		<li class="nav-item"><a class="nav-link"
			...
			<div class="collapse" id="ui-basic">
				<ul class="nav flex-column sub-menu">
					<li class="nav-item"><a class="nav-link"
						href="${base}/admin/cuahang">Cửa hàng</a></li>
					<li class="nav-item"><a class="nav-link"
		...
		<li class="nav-item"><a class="nav-link"
			...
			aria-controls="general-pages"> <span class="menu-title">Tài
					liệu Admin</span> <i class="menu-arrow"></i> <i
